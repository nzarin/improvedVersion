...
//			System.err.println("--------------------------------------");
//			System.err.println("kademliaid: " + kademliaid);
//			System.err.println("iNode network ID: " + iNode.getID());
//			System.err.println("iNode's current kademlia protocol ID: " + iKad.getKademliaProtocolID());
//			System.err.println("iNode's assigned node ID in kademlia protocol: " + iKad.getNodeId());
